	...
	private void messages() {
		...
		try {
			...
			try {
				...
				em.persist(new Message(LanguageEnum.ES, "type-not-null",
						"El tipo de equipo no puede ser nulo"));
				em.persist(new Message(LanguageEnum.ES,
						"external-provider-not-null",
						"El proveedor externo no puede ser nulo"));
				em.persist(new Message(LanguageEnum.ES, "name-not-null",
						"El nombre no pueder ser nulo"));
				em.persist(new Message(LanguageEnum.ES, "mobility-not-null",
