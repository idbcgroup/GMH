...
public class InitialData {
	...
	private final static Logger logger = Logger.getLogger(InitialData.class.getName());
	...
	private void parameter() {
		...
		try {
			...
			try {
				...
				ParameterGroup parameterGroup = new ParameterGroup("Valores por defecto");
				em.persist(parameterGroup);
				em.persist(new ParameterValue(parameterGroup, parameter, LanguageEnum.ES.name()));
				em.flush();
			} catch (Exception e1) {
	...
	private void messages() {
		...
		try {
			...
			try {
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "info-tittle", "Information"));
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "LOGIN001", "Inicio de sesión exitoso"));
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "LOGIN004", "Usuario deshabilitado"));
				em.persist(new GHAMessage(LanguageEnum.ES, "LOGIN005",
						"Usuario no registrado en el sistema"));
				em.persist(new GHAMessage(LanguageEnum.ES, "type-not-null", "Debe indicar el tipo"));
				em.persist(new GHAMessage(LanguageEnum.ES, "sub-type-not-null",
						"Debe indicar el sub tipo"));
				em.persist(new GHAMessage(LanguageEnum.ES, "external-provider-not-null",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "base-role-not-null",
						"Debe indicar el rol"));
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenance-provider-not-null",
						"Debe indicar el proveedor de mantenimiento"));
				em.persist(new GHAMessage(LanguageEnum.ES, "record-not-selected",
						"Debe seleccionar un registro"));
				em.persist(new GHAMessage(LanguageEnum.ES, "frecuency-not-null",
						"Debe indicar la frecuencia"));
				em.persist(new GHAMessage(LanguageEnum.ES, "time-period-not-null",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "material-save-success",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "mprot-save-success",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eiatype-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eiatype-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eiatype-findByMaintenancePlan-fail",
						"Búsqueda fallida del Tipo de Equipo por Plan de Mantenimeinto"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiatype-getAll-fail",
						"Búsqueda fallida de todos los Tipos de Equipo"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiatype-delete-fail",
						"Failed to delete Equipment type"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiatype-update-fail",
						"Failed to update Equipment type"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiatype-find-fail",
						"Failed to find Equipment Type"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiatype-findByMaintenancePlan-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "eiatype-getAll-fail",
						"Failed to get all Equipment types"));

				// function service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "function-getAll-fail",
						"Búsqueda fallida de todas las Funciones"));
				em.persist(new GHAMessage(LanguageEnum.EN, "function-getAll-fail",
						"Failed to get all Functions"));

				// instanceLogon service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "instanceLogon-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "instanceLogon-find-fail",
						"Búsqueda fallida de InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.ES, "instanceLogon-getAll-fail",
						"Búsqueda fallida de todos los InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.ES, "instanceLogon-save-fail",
						"Guardado fallido de InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.ES, "instanceLogon-update-fail",
						"Actualización fallida de InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN, "instanceLogon-delete-fail",
						"Failed to delete InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"instanceLogon-findByInstanceLogon-fail",
						"Failed to find InstanceLogon by instanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN, "instanceLogon-find-fail",
						"Failed to find InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN, "instanceLogon-getAll-fail",
						"Failed to get all instanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN, "instanceLogon-save-fail",
						"Failed to save InstanceLogon"));
				em.persist(new GHAMessage(LanguageEnum.EN, "instanceLogon-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "role-findByRoleBase-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "role-findByRoleBase-fail",
						"Failed to find Role by role"));
				em.persist(new GHAMessage(LanguageEnum.EN, "role-find-fail", "Failed to find Role"));
				em.persist(new GHAMessage(LanguageEnum.EN, "role-getAll-fail",
						"Failed to get all Role"));
				em.persist(new GHAMessage(LanguageEnum.EN, "role-save-fail", "Failed to save Role"));
				em.persist(new GHAMessage(LanguageEnum.EN, "role-update-fail",
						"Failed to update Role"));

				// ssoUser service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "ssoUser-delete-fail",
						"Fallo la eliminación del SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.ES, "ssoUser-findBySsoUser-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "ssoUser-getAll-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "ssoUser-update-fail",
						"Actualización fallida de SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.ES, "ssoUser-findByUserName-fail",
						"Búsqueda fallida de SSOUser por userName"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-delete-fail",
						"Failed to delete SSOUSer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-findBySsoUser-fail",
						"Failed to find SSOUser by ssoUser"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-find-fail",
						"Failed to find SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-getAll-fail",
						"Failed to get all SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-save-fail",
						"Failed to save SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-update-fail",
						"Failed to update SSOUser"));
				em.persist(new GHAMessage(LanguageEnum.EN, "ssoUser-findByUserName-fail",
						"Failed to find SSOUser by userName"));

				// bpuFunction service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "bpuFunction-save-fail",
						"Guardado fallido del BpuFunction"));
				em.persist(new GHAMessage(LanguageEnum.ES, "bpuFunction-delete-fail",
						"Fallo la eliminación del BpuFunction"));
				em.persist(new GHAMessage(LanguageEnum.ES, "bpuFunction-getFunctionsByBpu-fail",
						"Búsqueda fallida de BpuFunction por bpu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpuFunction-save-fail",
						"Failed to save BpuFunction"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpuFunction-delete-fail",
						"Failed to delete BpuFunction"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpuFunction-getFunctionsByBpu-fail",
						"Failed to get BpuFunction by bpu"));

				// workingArea service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-delete-fail",
						"Fallo la eliminación del WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-findByWorkingArea-fail",
						"Búsqueda fallida de WorkingArea por workingArea"));
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-find-fail",
						"Búsqueda fallida de WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-getAll-fail",
						"Búsqueda fallida de todos los WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-save-fail",
						"Guardado fallido de WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.ES, "workingArea-update-fail",
						"Actualización fallida de WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-delete-fail",
						"Failed to delete WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-findByWorkingArea-fail",
						"Failed to find WorkingArea by workingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-find-fail",
						"Failed to find WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-getAll-fail",
						"Failed to get all WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-save-fail",
						"Failed to save WorkingArea"));
				em.persist(new GHAMessage(LanguageEnum.EN, "workingArea-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "bpu-findByBpu-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "bpu-findByBpu-fail",
						"Failed to find Bpu by bpu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpu-find-fail", "Failed to find Bpu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpu-getAll-fail",
						"Failed to get all Bpu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpu-save-fail", "Failed to save Bpu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpu-update-fail",
						"Failed to update Bpu"));

				// facility service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-delete-fail",
						"Fallo la eliminación del Facility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-findByFacility-fail",
						"Búsqueda fallida de Facility por facility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-find-fail",
						"Búsqueda fallida de Facility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-getAll-fail",
						"Búsqueda fallida de todos los Facility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-save-fail",
						"Guardado fallido de Facility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "facility-update-fail",
						"Actualización fallida de Facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-delete-fail",
						"Failed to delete Facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-findByFacility-fail",
						"Failed to find Facility by facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-find-fail",
						"Failed to find Facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-getAll-fail",
						"Failed to get all Facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-save-fail",
						"Failed to save Facility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "facility-update-fail",
						"Failed to update Facility"));

				// obu service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "obu-delete-fail",
						"Fallo la eliminación del Obu"));
				em.persist(new GHAMessage(LanguageEnum.ES, "obu-findByObu-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "obu-findByObu-fail",
						"Failed to find Obu by obu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "obu-find-fail", "Failed to find Obu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "obu-getAll-fail",
						"Failed to get all Obu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "obu-save-fail", "Failed to save Obu"));
				em.persist(new GHAMessage(LanguageEnum.EN, "obu-update-fail",
						"Failed to update Obu"));

				// externalProvider service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "externalProvider-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "externalProvider-find-fail",
						"Búsqueda fallida de ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.ES, "externalProvider-getAll-fail",
						"Búsqueda fallida de todos los ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.ES, "externalProvider-save-fail",
						"Guardado fallido de ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.ES, "externalProvider-update-fail",
						"Actualización fallida de ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN, "externalProvider-delete-fail",
						"Failed to delete ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"externalProvider-findByExternalProvider-fail",
						"Failed to find ExternalProvider by externalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN, "externalProvider-find-fail",
						"Failed to find ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN, "externalProvider-getAll-fail",
						"Failed to get all ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN, "externalProvider-save-fail",
						"Failed to save ExternalProvider"));
				em.persist(new GHAMessage(LanguageEnum.EN, "externalProvider-update-fail",
						"Failed to update ExternalProvider"));

				// materialCategory service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "materialCategory-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "materialCategory-find-fail",
						"Búsqueda fallida de MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.ES, "materialCategory-getAll-fail",
						"Búsqueda fallida de todos los MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.ES, "materialCategory-save-fail",
						"Guardado fallido de MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.ES, "materialCategory-update-fail",
						"Actualización fallida de MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN, "materialCategory-delete-fail",
						"Failed to delete MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"materialCategory-findByMaterialCategory-fail",
						"Failed to find MaterialCategory by materialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN, "materialCategory-find-fail",
						"Failed to find MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN, "materialCategory-getAll-fail",
						"Failed to get all MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN, "materialCategory-save-fail",
						"Failed to save MaterialCategory"));
				em.persist(new GHAMessage(LanguageEnum.EN, "materialCategory-update-fail",
						"Failed to update MaterialCategory"));

				// material service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "material-delete-fail",
						"Fallo la eliminación del Material"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-findByMaterial-fail",
						"Búsqueda fallida de Material por material"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-find-fail",
						"Búsqueda fallida de Material"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-findByType-fail",
						"Búsqueda fallida de Material por Tipo"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-findByBrand-fail",
						"Búsqueda fallida de Material por Brand"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-getAll-fail",
						"Búsqueda fallida de todos los Material"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-save-fail",
						"Guardado fallido de Material"));
				em.persist(new GHAMessage(LanguageEnum.ES, "material-update-fail",
						"Actualización fallida de Material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-delete-fail",
						"Failed to delete Material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-findByMaterial-fail",
						"Failed to find Material by material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-find-fail",
						"Failed to find Material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-findByType-fail",
						"Failed to find Material by Type"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-findByBrand-fail",
						"Falied to find Material by Brand"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-getAll-fail",
						"Failed to get all Material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-save-fail",
						"Failed to save Material"));
				em.persist(new GHAMessage(LanguageEnum.EN, "material-update-fail",
						"Failed to update Material"));

				// brand service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "brand-delete-fail",
						"Fallo la eliminación del Brand"));
				em.persist(new GHAMessage(LanguageEnum.ES, "brand-findByBrand-fail",
						"Búsqueda fallida de Brand por brand"));
				em.persist(new GHAMessage(LanguageEnum.ES, "brand-find-fail",
						"Búsqueda fallida de Brand"));
				em.persist(new GHAMessage(LanguageEnum.ES, "brand-findByManufacturer-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "brand-findByBrand-fail",
						"Failed to find Brand by brand"));
				em.persist(new GHAMessage(LanguageEnum.EN, "brand-find-fail",
						"Failed to find Brand"));
				em.persist(new GHAMessage(LanguageEnum.EN, "brand-findByManufacturer-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "buildingLocation-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "buildingLocation-find-fail",
						"Búsqueda fallida de BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.ES, "buildingLocation-getAll-fail",
						"Búsqueda fallida de todos los BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.ES, "buildingLocation-save-fail",
						"Guardado fallido de BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.ES, "buildingLocation-update-fail",
						"Actualización fallida de BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN, "buildingLocation-delete-fail",
						"Failed to delete BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"buildingLocation-findByBuildingLocation-fail",
						"Failed to find BuildingLocation by buildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN, "buildingLocation-find-fail",
						"Failed to find BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN, "buildingLocation-getAll-fail",
						"Failed to get all BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN, "buildingLocation-save-fail",
						"Failed to save BuildingLocation"));
				em.persist(new GHAMessage(LanguageEnum.EN, "buildingLocation-update-fail",
						"Failed to update BuildingLocation"));

				// eiaComponent service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-delete-fail",
						"Fallo la eliminación del EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-findByParentEia-fail",
						"Búsqueda fallida de EiaComponent por parentEia"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-find-fail",
						"Búsqueda fallida de EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-getAll-fail",
						"Búsqueda fallida de todos los EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-save-fail",
						"Guardado fallido de EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaComponent-update-fail",
						"Actualización fallida de EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-delete-fail",
						"Failed to delete EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-findByParentEia-fail",
						"Failed to find EiaComponent by parentEia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-find-fail",
						"Failed to find EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-getAll-fail",
						"Failed to get all EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-save-fail",
						"Failed to save EiaComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaComponent-update-fail",
						"Failed to update EiaComponent"));

				// eiaPicture service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-delete-fail",
						"Fallo la eliminación del EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-findByEia-fail",
						"Búsqueda fallida de EiaPicture por eia"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-find-fail",
						"Búsqueda fallida de EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-getAll-fail",
						"Búsqueda fallida de todos los EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-save-fail",
						"Guardado fallido de EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaPicture-update-fail",
						"Actualización fallida de EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-delete-fail",
						"Failed to delete EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-findByEia-fail",
						"Failed to find EiaPicture by eia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-find-fail",
						"Failed to find EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-getAll-fail",
						"Failed to get all EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-save-fail",
						"Failed to save EiaPicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaPicture-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eia-findByEia-fail",
						"Búsqueda fallida de Eia por eia"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eia-findByEiaType-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-findByEia-fail",
						"Failed to find Eia by eia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-findByEiaType-fail",
						"Failed to find Eia by eiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-find-fail", "Failed to find Eia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-getAll-fail",
						"Failed to get all Eia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-save-fail", "Failed to save Eia"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eia-update-fail",
						"Failed to update Eia"));

				// eiaTypeComponent service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeComponent-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeComponent-find-fail",
						"Búsqueda fallida de EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeComponent-getAll-fail",
						"Búsqueda fallida de todos los EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeComponent-save-fail",
						"Guardado fallido de EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeComponent-update-fail",
						"Actualización fallida de EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeComponent-delete-fail",
						"Failed to delete EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"eiaTypeComponent-findByParentEiaType-fail",
						"Failed to find EiaTypeComponent by parentEiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeComponent-find-fail",
						"Failed to find EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeComponent-getAll-fail",
						"Failed to get all EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeComponent-save-fail",
						"Failed to save EiaTypeComponent"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeComponent-update-fail",
						"Failed to update EiaTypeComponent"));

				// eiaTypeMaintenancePlan service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeMaintenancePlan-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeMaintenancePlan-save-fail",
						"Guardado fallido de EiaTypeMaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeMaintenancePlan-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeMaintenancePlan-save-fail",
						"Failed to save EiaTypeMaintenancePlan"));

				// eiaTypeMaterial service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeMaterial-delete-fail",
						"Fallo la eliminación del EiaTypeMaterial"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeMaterial-findByEiaType-fail",
						"Búsqueda fallida de EiaTypeMaterial por eiaType"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeMaterial-save-fail",
						"Guardado fallido de EiaTypeMaterial"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeMaterial-delete-fail",
						"Failed to delete EiaTypeMaterial"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeMaterial-findByEiaType-fail",
						"Failed to find EiaTypeMaterial by eiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeMaterial-save-fail",
						"Failed to save EiaTypeMaterial"));

				// eiaTypePicture service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypePicture-delete-fail",
						"Fallo la eliminación del EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypePicture-findByEiaType-fail",
						"Búsqueda fallida de EiaTypePicture por eiaType"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypePicture-find-fail",
						"Búsqueda fallida de EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypePicture-save-fail",
						"Guardado fallido de EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypePicture-update-fail",
						"Actualización fallida de EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypePicture-delete-fail",
						"Failed to delete EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypePicture-findByEiaType-fail",
						"Failed to find EiaTypePicture by eiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypePicture-find-fail",
						"Failed to find EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypePicture-save-fail",
						"Failed to save EiaTypePicture"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypePicture-update-fail",
						"Failed to update EiaTypePicture"));

				// eiaTypeUtility service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeUtility-delete-fail",
						"Fallo la eliminación del EiaTypeUtility"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeUtility-findByEiaType-fail",
						"Búsqueda fallida de EiaTypeUtility por eiaType"));
				em.persist(new GHAMessage(LanguageEnum.ES, "eiaTypeUtility-save-fail",
						"Guardado fallido de EiaTypeUtility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeUtility-delete-fail",
						"Failed to delete EiaTypeUtility"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeUtility-findByEiaType-fail",
						"Failed to find EiaTypeUtility by eiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN, "eiaTypeUtility-save-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceActivity-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceActivity-find-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceActivity-getAll-fail",
						"Búsqueda fallida de todos los MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceActivity-save-fail",
						"Guardado fallido de MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceActivity-update-fail",
						"Actualización fallida de MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceActivity-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceActivity-find-fail",
						"Failed to find MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"maintenanceActivity-findByMaintenanceActivity-fail",
						"Failed to find MaintenanceActivity by maintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceActivity-getAll-fail",
						"Failed to get all MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceActivity-save-fail",
						"Failed to save MaintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceActivity-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-delete-fail",
						"Fallo la eliminación del MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-findByEiaType-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-find-fail",
						"Búsqueda fallida de MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-getAll-fail",
						"Búsqueda fallida de todos los MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-save-fail",
						"Guardado fallido de MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenancePlan-update-fail",
						"Actualización fallida de MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-delete-fail",
						"Failed to delete MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-findByEiaType-fail",
						"Failed to find MaintenancePlan by eiaType"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"maintenancePlan-findByMaintenancePlan-fail",
						"Failed to find MaintenancePlan by maintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-find-fail",
						"Failed to find MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-getAll-fail",
						"Failed to get all MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-save-fail",
						"Failed to save MaintenancePlan"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenancePlan-update-fail",
						"Failed to update MaintenancePlan"));

				// maintenanceProtocol service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceProtocol-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceProtocol-find-fail",
						"Búsqueda fallida de MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceProtocol-getAll-fail",
						"Búsqueda fallida de todos los MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceProtocol-save-fail",
						"Guardado fallido de MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceProtocol-update-fail",
						"Actualización fallida de MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceProtocol-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceProtocol-find-fail",
						"Failed to find MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceProtocol-getAll-fail",
						"Failed to get all MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceProtocol-save-fail",
						"Failed to save MaintenanceProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceProtocol-update-fail",
						"Failed to update MaintenanceProtocol"));

				// maintenanceSubProtocol service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceSubProtocol-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceSubProtocol-find-fail",
						"Búsqueda fallida de MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceSubProtocol-getAll-fail",
						"Búsqueda fallida de todos los MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceSubProtocol-save-fail",
						"Guardado fallido de MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.ES, "maintenanceSubProtocol-update-fail",
						"Actualización fallida de MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceSubProtocol-delete-fail",
						"Failed to delete MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"maintenanceSubProtocol-findByMaintenanceActivity-fail",
						"Failed to find MaintenanceSubProtocol by maintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceSubProtocol-find-fail",
						"Failed to find MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceSubProtocol-getAll-fail",
						"Failed to get all MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceSubProtocol-save-fail",
						"Failed to save MaintenanceSubProtocol"));
				em.persist(new GHAMessage(LanguageEnum.EN, "maintenanceSubProtocol-update-fail",
						"Failed to update MaintenanceSubProtocol"));

				// manufacturer service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-delete-fail",
						"Fallo la eliminación del Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-findByManufacturer-fail",
						"Búsqueda fallida de Manufacturer por manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-find-fail",
						"Búsqueda fallida de Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-getAll-fail",
						"Búsqueda fallida de todos los Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-save-fail",
						"Guardado fallido de Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.ES, "manufacturer-update-fail",
						"Actualización fallida de Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-delete-fail",
						"Failed to delete Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-findByManufacturer-fail",
						"Failed to find Manufacturer by manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-find-fail",
						"Failed to find Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-getAll-fail",
						"Failed to get all Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-save-fail",
						"Failed to save Manufacturer"));
				em.persist(new GHAMessage(LanguageEnum.EN, "manufacturer-update-fail",
						"Failed to update Manufacturer"));

				// serviceResource service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "serviceResource-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "serviceResource-find-fail",
						"Búsqueda fallida de ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.ES, "serviceResource-getAll-fail",
						"Búsqueda fallida de todos los ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.ES, "serviceResource-save-fail",
						"Guardado fallido de ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.ES, "serviceResource-update-fail",
						"Actualización fallida de ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.EN, "serviceResource-delete-fail",
						"Failed to delete ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"serviceResource-findByMaintenanceActivity-fail",
						"Failed to find ServiceResource by maintenanceActivity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "serviceResource-find-fail",
						"Failed to find ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.EN, "serviceResource-getAll-fail",
						"Failed to get all ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.EN, "serviceResource-save-fail",
						"Failed to save ServiceResource"));
				em.persist(new GHAMessage(LanguageEnum.EN, "serviceResource-update-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "bpa-findByBpa-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "bpa-findByBpa-fail",
						"Failed to find Bpa by bpa"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpa-find-fail", "Failed to find Bpa"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpa-getAll-fail",
						"Failed to get all Bpa"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpa-save-fail", "Failed to save Bpa"));
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "bpi-findByBpi-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.EN, "bpi-findByBpi-fail",
						"Failed to find Bpi by bpi"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpi-find-fail", "Failed to find Bpi"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpi-getAll-fail",
						"Failed to get all Bpi"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpi-save-fail", "Failed to save Bpi"));
				em.persist(new GHAMessage(LanguageEnum.EN, "bpi-update-fail",
						"Failed to update Bpi"));

				// citizen service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "citizen-delete-fail",
						"Fallo la eliminación del Citizen"));
				em.persist(new GHAMessage(LanguageEnum.ES, "citizen-findByCitizen-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "citizen-getAll-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "citizen-update-fail",
						"Actualización fallida de Citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-delete-fail",
						"Failed to delete Citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-findByCitizen-fail",
						"Failed to find Citizen by citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-find-fail",
						"Failed to find Citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-getAll-fail",
						"Failed to get all Citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-save-fail",
						"Failed to save Citizen"));
				em.persist(new GHAMessage(LanguageEnum.EN, "citizen-update-fail",
						"Failed to update Citizen"));

				// institution service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-delete-fail",
						"Fallo la eliminación del Institution"));
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-findByInstitution-fail",
						"Búsqueda fallida de Institution por institution"));
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-find-fail",
						"Búsqueda fallida de Institution"));
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-getAll-fail",
						"Búsqueda fallida de todos los Institution"));
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-save-fail",
						"Guardado fallido de Institution"));
				em.persist(new GHAMessage(LanguageEnum.ES, "institution-update-fail",
						"Actualización fallida de Institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-delete-fail",
						"Failed to delete Institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-findByInstitution-fail",
						"Failed to find Institution by institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-find-fail",
						"Failed to find Institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-getAll-fail",
						"Failed to get all Institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-save-fail",
						"Failed to save Institution"));
				em.persist(new GHAMessage(LanguageEnum.EN, "institution-update-fail",
						"Failed to update Institution"));

				// legalEntity service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-delete-fail",
						"Fallo la eliminación del LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-findByLegalEntity-fail",
						"Búsqueda fallida de LegalEntity por legalEntity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-find-fail",
						"Búsqueda fallida de LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-getAll-fail",
						"Búsqueda fallida de todos los LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-save-fail",
						"Guardado fallido de LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.ES, "legalEntity-update-fail",
						"Actualización fallida de LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-delete-fail",
						"Failed to delete LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-findByLegalEntity-fail",
						"Failed to find LegalEntity by legalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-find-fail",
						"Failed to find LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-getAll-fail",
						"Failed to get all LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-save-fail",
						"Failed to save LegalEntity"));
				em.persist(new GHAMessage(LanguageEnum.EN, "legalEntity-update-fail",
						"Failed to update LegalEntity"));

				// systemInstance service messages
				em.persist(new GHAMessage(LanguageEnum.ES, "systemInstance-delete-fail",
				...
				em.persist(new GHAMessage(LanguageEnum.ES, "systemInstance-find-fail",
						"Búsqueda fallida de SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.ES, "systemInstance-getAll-fail",
						"Búsqueda fallida de todos los SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.ES, "systemInstance-save-fail",
						"Guardado fallido de SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.ES, "systemInstance-update-fail",
						"Actualización fallida de SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN, "systemInstance-delete-fail",
						"Failed to delete SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN,
						"systemInstance-findBySystemInstance-fail",
						"Failed to find SystemInstance by systemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN, "systemInstance-find-fail",
						"Failed to find SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN, "systemInstance-getAll-fail",
						"Failed to get all SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN, "systemInstance-save-fail",
						"Failed to save SystemInstance"));
				em.persist(new GHAMessage(LanguageEnum.EN, "systemInstance-update-fail",
	...
	private void uiStrings() {
		...
		try {
			...
			try {
				...
				em.persist(new UiString(LanguageEnum.ES, "new-material", "Nuevo material"));
				...
				em.persist(new UiString(LanguageEnum.ES, "external-code", "Codigo externo"));// TODO
																								// acento
				em.persist(new UiString(LanguageEnum.ES, "materials", "Materiales"));
				em.persist(new UiString(LanguageEnum.ES, "name", "Nombre"));
				em.persist(new UiString(LanguageEnum.ES, "components", "Componentes"));
				em.persist(new UiString(LanguageEnum.ES, "information", "Información"));
				em.persist(new UiString(LanguageEnum.ES, "reports", "Reportes"));
				em.persist(new UiString(LanguageEnum.ES, "equipments", "Equipos"));
				em.persist(new UiString(LanguageEnum.ES, "password", "Clave de acceso"));
				...
				em.persist(new UiString(LanguageEnum.ES, "manufacturer", "Fabricante"));
				em.persist(new UiString(LanguageEnum.ES, "mobility", "Movilidad"));
				em.persist(new UiString(LanguageEnum.ES, "eiatype", "Tipo de equipo"));
				em.persist(new UiString(LanguageEnum.ES, "eiatypes", "Tipos de equipo"));
				em.persist(new UiString(LanguageEnum.ES, "subtype", "Sub tipo"));
				em.persist(new UiString(LanguageEnum.ES, "brand", "Marca"));
				em.persist(new UiString(LanguageEnum.ES, "new-eia", "Nuevo equipo"));
				em.persist(new UiString(LanguageEnum.ES, "new-eiatype", "Nuevo tipo de equipo"));
				em.persist(new UiString(LanguageEnum.ES, "search-results",
						"Resultados de la búsqueda"));
				em.persist(new UiString(LanguageEnum.ES, "description", "Descripción"));
				...
				em.persist(new UiString(LanguageEnum.ES, "first-name", "Primer nombre"));
				em.persist(new UiString(LanguageEnum.ES, "last-name", "Apellido"));
				em.persist(new UiString(LanguageEnum.ES, "id-type", "Tipo de identificación"));// TODO
																								// acento
				em.persist(new UiString(LanguageEnum.ES, "id-number", "Numero de identificación"));// TODO
																									// acento
				em.persist(new UiString(LanguageEnum.ES, "eiatype-select-item", "Tipo de Equipo"));
				em.persist(new UiString(LanguageEnum.ES, "eiastate-select-item", "Estado"));
				em.persist(new UiString(LanguageEnum.ES, "serialNumber-item", "Serial"));
				em.persist(new UiString(LanguageEnum.ES, "fixedAssetIdentifier-item",
						"Id Activo Fijo"));
				em.persist(new UiString(LanguageEnum.ES, "workingarea-select-item",
						"Area de Trabajo"));
				em.persist(new UiString(LanguageEnum.ES, "facility-select-item", "Instalación"));
				em.persist(new UiString(LanguageEnum.ES, "obu-select-item",
						"Departamento Responsable"));
				em.persist(new UiString(LanguageEnum.ES, "role-select-item", "Rol Responsable"));
				...
				em.persist(new UiString(LanguageEnum.ES, "search-material", "Buscar un material"));
				em.persist(new UiString(LanguageEnum.ES, "record-not-selected",
						"Debe seleccionar un registro"));
				em.persist(new UiString(LanguageEnum.ES, "search-utility-material",
	...
	private void modules() {
		String query = "SELECT t from Module t WHERE t.code ='" + ModulesCodes.USER + "'";
		try {
			em.createQuery(query).getSingleResult();
		} catch (NoResultException e) {
			try {
				...
				Module moduleEiaType = new Module("Tipos de equipo", ModulesCodes.EIATYPE);
				em.persist(moduleEiaType);
				Module moduleEia = new Module("Equipos", ModulesCodes.EIA);
				em.persist(moduleEia);
				Module moduleMainteancePlan = new Module("Planes de Mant.", ModulesCodes.MPLAN);
				em.persist(moduleMainteancePlan);
				Module moduleMaintenanceProtocol = new Module("Protocolos de Mant.",
						ModulesCodes.MPROT);
				em.persist(moduleMaintenanceProtocol);
				Module maintenanceActivityModule = new Module("Actividades de Mant.",
						ModulesCodes.MACT);
				...
				Screen screenEiaType = new Screen(moduleEiaType, "Tipos de equipo",
						ScreenCodes.EIATYPE_ADM, "eiatype");
				em.persist(screenEiaType);
				Screen screenEia = new Screen(moduleEia, "Equipos", ScreenCodes.EIA_ADM, "eia");
				em.persist(screenEia);
				Screen screenMaintenancePlan = new Screen(moduleMainteancePlan, "Planes de Mant.",
						ScreenCodes.MAINTENANCE_PLAN_ADM, "mplan");
				em.persist(screenMaintenancePlan);
				Screen screenMaintenanceProtocol = new Screen(moduleMaintenanceProtocol,
						"Protocolos de Mant.", ScreenCodes.MAINTENANCE_PROTOCOL_ADM, "mprot");
				em.persist(screenMaintenanceProtocol);

				Screen maintenanceActivityScreen = new Screen(maintenanceActivityModule,
						"Actividades de Mant.", ScreenCodes.MAINTENANCE_ACTIVITY_ADM, "mact");
				em.persist(maintenanceActivityScreen);

				// View
				View viewUserInfo = new View(screenUsuer, "Información", ViewCodes.USER_ADM_INFO);
				em.persist(viewUserInfo);
				View viewUserCred = new View(screenUsuer, "Credenciales", ViewCodes.USER_ADM_CRED);
				em.persist(viewUserCred);
				View viewUserLLog = new View(screenUsuer, "Logon log", ViewCodes.USER_ADM_LLOG);
				...
				View viewEiaTypeServ = new View(screenEiaType, "Servicios utilitarios",
						ViewCodes.EIATYPE_ADM_SERV);
				em.persist(viewEiaTypeServ);
				View viewEiaInfo = new View(screenEia, "Información", ViewCodes.EIA_ADM_INFO);
				em.persist(viewEiaInfo);
				View viewEiaComp = new View(screenEia, "Componentes", ViewCodes.EIA_ADM_COMP);
				em.persist(viewEiaComp);
				View viewMaintenancePlanInfo = new View(screenMaintenancePlan, "Información",
						ViewCodes.MAINTENANCE_PLAN_ADM_INFO);
				em.persist(viewMaintenancePlanInfo);
				View viewMaintenanceProtocol = new View(screenMaintenanceProtocol, "Información",
						ViewCodes.MAINTENANCE_PROTOCOL_ADM_INFO);
				em.persist(viewMaintenanceProtocol);
				View viewProtocolActivity = new View(screenMaintenanceProtocol, "Actividades",
						ViewCodes.MAINTENANCE_PROTOCOL_ADM_ACT);
				em.persist(viewProtocolActivity);
				View maintenanceActivityView = new View(maintenanceActivityScreen, "Información",
				...
				em.persist(function);
				function = new Function(viewUserInfo, "editar", FunctionsCodes.USER_ADM_INFO_EDIT);
				em.persist(function);
				function = new Function(viewUserCred, "ver", FunctionsCodes.USER_ADM_CRED_VIEW);
				em.persist(function);
				function = new Function(viewUserCred, "editar", FunctionsCodes.USER_ADM_CRED_EDIT);
				em.persist(function);
				function = new Function(viewUserLLog, "ver", FunctionsCodes.USER_ADM_LLOG_VIEW);
				em.persist(function);
				function = new Function(viewUserLLog, "editar", FunctionsCodes.USER_ADM_LLOG_EDIT);
				em.persist(function);
				...
				em.persist(function);
				function = new Function(viewEiaInfo, "ver", FunctionsCodes.EIA_ADM_INFO_VIEW);
				em.persist(function);
				function = new Function(viewEiaInfo, "editar", FunctionsCodes.EIA_ADM_INFO_EDIT);
				em.persist(function);
				function = new Function(viewEiaComp, "ver", FunctionsCodes.EIA_ADM_COMP_VIEW);
				em.persist(function);
				function = new Function(viewEiaComp, "editar", FunctionsCodes.EIA_ADM_COMP_EDIT);
				em.persist(function);
				...
				logger.log(Level.INFO, "error creating test data: module, view, screen, functions",
						e1);
			}
		}
	}
	...
	private void eiaTypeMaintenancePlanTestData() {
		...
		try {
			...
			try {
				...
				em.persist(new EiaTypeMaintenancePlan(em.find(EiaType.class, "90001"), em.find(
						MaintenancePlan.class, 1L)));
				em.persist(new EiaTypeMaintenancePlan(em.find(EiaType.class, "90002"), em.find(
						MaintenancePlan.class, 2L)));
				em.flush();
	...
	private void maintenanceActivityProtocolTestData() {
		...
		try {
			...
			try {
				...
				List<MaintenanceProtocol> protocols = em.createNamedQuery(
						"MaintenanceProtocol.getAll", MaintenanceProtocol.class).getResultList();
				List<MaintenanceActivity> activities = em.createNamedQuery(
						"MaintenanceActivity.getAll", MaintenanceActivity.class).getResultList();

				for (int i = 0; i < 4; ++i) {
					em.persist(new MaintenanceActivityMaintenanceProtocol(protocols.get(0),
							activities.get(i), i + 1));
					em.persist(new MaintenanceActivityMaintenanceProtocol(protocols.get(1),
							activities.get(i), i + 1));
				}

				em.persist(new MaintenanceActivityMaintenanceProtocol(protocols.get(0), activities
						.get(4), 5));
				em.persist(new MaintenanceActivityMaintenanceProtocol(protocols.get(1), activities
						.get(5), 5));
	...
	private void MaintenancePlanMaintenanceProtocol() {
		...
		try {
			...
			try {
				...
				List<MaintenanceProtocol> protocols = em.createNamedQuery(
						"MaintenanceProtocol.getAll", MaintenanceProtocol.class).getResultList();
				List<MaintenancePlan> plans = em.createNamedQuery("MaintenancePlan.getAll",
	...
	private void maintenanceProtocolTestData() {
		...
		try {
			...
			try {
				...
				String protocolNames[] = { "Protocolo para Impresoras de Tinta",
						"Protocolo para impresoras Laser" };
				String protocolDesc[] = { "Protocolo para el mantenimiento de impresoras de tinta",
				...
				logger.log(Level.INFO, "error Creating MaintenanceProtocol test data", e1);
			}
		}
	}
	...
	private void maintenancePlanTestData() {
		...
		try {
			...
			try {
				...
				TimePeriodEnum planTimePeriod[] = { TimePeriodEnum.MONTHS, TimePeriodEnum.SEMESTERS };
				for (int i = 0; i < 2; ++i) {
				...
				logger.log(Level.INFO, "error Creating MaintenancePlan test data", e1);
			}
		}
	}
	...
	private void bpuTestData() {
		...
		try {
			...
			try {
				...
				for (int i = 0; i < 5; ++i)
					em.persist(new Bpu(em.find(Bpi.class, 1L), em.find(Citizen.class, i + 1L)));
				em.flush();
			} catch (Exception e1) {
		...
		try {
			...
			try {
				...
				for (Function function : all) {
					...
					if (function.getCode().matches("^EIATYPE-ADM-(EQUI|COMP)-(VIEW|EDIT)$")) {
	...
	private void citizenTestData() {
		...
		try {
			...
			try {
				...
				for (int i = 0; i < 5; ++i) {
					Citizen citizen = new Citizen(em.find(LegalEntity.class, i + 5L),
							GenderTypeEnum.MALE);
				...
				logger.log(Level.INFO, "error creating Citizen test data : ", e1);
			}
		}
	...
	private void materialCategoryTestData() {
		...
		try {
			...
			try {
				...
				logger.log(Level.INFO, "error creating test data: external provider", e);
			}
		}
	}
	...
	private void facilityTestData() {
		...
		try {
			...
			for (int i = 3, j = 0; i < 5; ++i, ++j) {
				...
				facility.setBuildingLocation(em.find(BuildingLocation.class, "Building 00" + i));
				em.persist(facility);
			}
			em.flush();
		}
	...
	private void materialTestData() {
		...
		try {
			...
			try {
				...
				for (int j = 0; j < 3; j++) {
					MaterialCategory next = new MaterialCategory("mat-00" + j, "material-00" + j,
							MaterialTypeEnum.values()[j % 3]);
	...
	private void workingAreaTestData() {
		...
		try {
			...
			String workingAreaNames[] = { "Enfermería Emergencia", "Enfermería U.C.I",
	...
	private void maintenanceActivityTestData() {
		...
		try {
			...
			try {
				...
				String activityNames[] = { "Desconectar", "Abrir", "Limpiar", "Cerrar", "Conectar",
						"Reemplazar" };
				String activityDesc[] = {
		...
		try {
			...
			try {
				...
				for (int j = 0; j < 3; j++) {
					...
					eP.setInstitution(em.find(Institution.class, Long.valueOf(j + 3)));
					em.persist(eP);
				}
				em.flush();
			} catch (Exception e1) {
	...
	private void legalEntityTestData() {
		...
		try {
			...
			try {
				...
				logger.log(Level.INFO, "error creating test data legal entity", e);
			}
		}
	}
		...
		try {
			...
			try {
				...
				for (int i = 0; i < 5; i++) {
					...
					institution.setLegalEntity(em.find(LegalEntity.class, Long.valueOf(i + 1L)));
					em.persist(institution);
				}
				em.flush();
			} catch (Exception e1) {
				logger.log(Level.INFO, "error creating test data institution", e1);
			}
		}
	}
			...
			try {
				...
				for (int i = 0; i < 5; i++) {
					BuildingLocation buildingLocation = new BuildingLocation(
							em.find(Bpi.class, 1L), "Building 00" + i, LocationLevelEnum.BUILDING,
							"Building Location Name " + i);
					em.persist(buildingLocation);
				}
				em.flush();
			} catch (Exception e1) {
				logger.log(Level.INFO, "error creating test building location", e);
			}
		}
	}
	...
	private void brandTestData() {
		try {
			...
			try {
				...
				List<Manufacturer> mans = em.createNamedQuery("Manufacturer.getAll",
	...
	private void eiaTypeTestData() {
		...
		try {
			...
			try {
				...
				EiaType eiaType = new EiaType("90001", em.find(Brand.class, 1L), "Impresora Tinta",
						EiaMobilityEnum.FIXED, EiaTypeEnum.EQUIPMENT, EiaSubTypeEnum.IT_SYSTEM,
						"Stylus");
				em.persist(eiaType);

				eiaType = new EiaType("90002", em.find(Brand.class, 2L), "Impresora Laser",
						EiaMobilityEnum.FIXED, EiaTypeEnum.EQUIPMENT, EiaSubTypeEnum.IT_SYSTEM,
						"Deskjet");
				em.persist(eiaType);

				eiaType = new EiaType("90003", em.find(Brand.class, 3L), "Cartucho Tricolor",
						EiaMobilityEnum.FIXED, EiaTypeEnum.PART, EiaSubTypeEnum.IT_SYSTEM, "EP60");
				em.persist(eiaType);

				eiaType = new EiaType("90004", em.find(Brand.class, 4L), "Toner Laser",
						EiaMobilityEnum.FIXED, EiaTypeEnum.PART, EiaSubTypeEnum.IT_SYSTEM, "HP60");
				em.persist(eiaType);

				eiaType = new EiaType("90005", em.find(Brand.class, 5L), "Cartucho Negro",
						EiaMobilityEnum.FIXED, EiaTypeEnum.PART, EiaSubTypeEnum.IT_SYSTEM, "EPN60");
				em.persist(eiaType);
	...
	private void eiaTestData() {
		...
		try {
			...
			try {
				...
				for (int i = 1; i < 4; ++i) {
					Eia eia = new Eia(bRole, em.find(EiaType.class, "9000" + Long.toString(i)),
							obu, EiaStateEnum.values()[i % 3], "GHAEQ-00" + i, eProvider,
							"S9023423" + i);
	...
	private void ssoUserTestData() {
		...
		try {
			...
			try {
				...
				em.persist(new SSOUser(em.find(Bpu.class, 2L), "asanchez", "asanchez",
						UserLogonStatusEnum.STAYIN));
