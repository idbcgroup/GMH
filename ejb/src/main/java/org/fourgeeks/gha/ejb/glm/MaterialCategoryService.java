...
public class MaterialCategoryService implements MaterialCategoryServiceRemote {
	...
	private final static Logger logger = Logger.getLogger(MaterialCategoryService.class
			.getName());
	
	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#delete(long)
	 */
	@Override
	public void delete(long Id) throws EJBException {
		try {
			...
			logger.log(Level.INFO, "ERROR: unable to delete MaterialCategory", e);
	...
	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#find(org.fourgeeks.gha.domain.glm.MaterialCategory)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#find(long)
	 */
	@Override
	...
	public List<MaterialCategory> getAll() throws EJBException {
		try {
			return em.createNamedQuery("MaterialCategory.getAll", MaterialCategory.class)
					.getResultList();
		} catch (Exception ex) {
			logger.log(Level.SEVERE, "Error retrieving all MaterialCategories", ex);
			throw new EJBException("Error obteniendo todas los MaterialCategories"
					+ ex.getCause().getMessage());
		}
	}

	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#getAll(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#save(org.fourgeeks.gha.domain.glm.MaterialCategory)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.fourgeeks.gha.domain.glm.MaterialCategoryServiceRemote#update(org.fourgeeks.gha.domain.glm.MaterialCategory)
	 */
	@Override
	public MaterialCategory update(MaterialCategory materialCategory)
		...
		try {
			...
			logger.log(Level.INFO, "ERROR: unable to update MaterialCategory ", e);
			throw new EJBException("ERROR: no se puede eliminar el MaterialCategory "
					+ e.getCause().getMessage());
		}
	}
