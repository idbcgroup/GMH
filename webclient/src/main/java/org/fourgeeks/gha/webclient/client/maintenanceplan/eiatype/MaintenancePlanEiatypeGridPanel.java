 ...
 * 
 */
public class MaintenancePlanEiatypeGridPanel extends VLayout implements
	 ...
	 */
	public MaintenancePlanEiatypeGridPanel(
			MaintenancePlanEiaTypeSubTab eIATypeEquipmentSubTab) {
		super();
