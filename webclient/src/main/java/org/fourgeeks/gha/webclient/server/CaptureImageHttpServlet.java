 ...
 * 
 */
@WebServlet(urlPatterns = { "/webclient/picture/*" })
public class CaptureImageHttpServlet extends HttpServlet {
	...
	private static final Logger LOG = Logger
			.getLogger(CaptureImageHttpServlet.class);
	...
	private String getURLPhotograph() {
		...
		try {
			...
			url = (String) env.lookup("EIATYPE_IMAGES") + USER_NAME
					+ "/GHA/Imagenes";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String pictureName = req.getPathInfo().substring(
				req.getPathInfo().lastIndexOf("/"));
