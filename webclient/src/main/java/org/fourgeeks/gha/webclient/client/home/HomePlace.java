...
///////////////////Menu
        ...
        showTab1.addClickHandler(new com.smartgwt.client.widgets.events.ClickHandler() {
			@Override
        ...
        showTab2.addClickHandler(new com.smartgwt.client.widgets.events.ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
        ...
        showTab3.addClickHandler(new com.smartgwt.client.widgets.events.ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
...
///////////////Draw
        ...
        layout.draw();
        RootPanel.get("menu-bar").add(menulayout);
        menulayout.draw();
	}
