...
import org.fourgeeks.gha.webclient.client.maintenanceplan.equipments.MaintenancePlanEquipmentSubTab;
...
public class MaintenancePlanInternalTabset extends TabSet implements
	...
	private MaintenancePlanEquipmentSubTab maintenancePlanEquipmentSubTab;
...
//	private EIAMovementsSubTab eiaMovementsSubTab;
	...
	public MaintenancePlanInternalTabset(MaintenancePlanTab mpTab) {
		...
		maintenancePlanEquipmentSubTab = new MaintenancePlanEquipmentSubTab(mpTab);
