...
public class EIATypeMaintenanceGridPanel extends VLayout implements EIATypeSelectionListener{
...
//	     				History.newItem("eia/" + selectedRecord.getCode());
 		...
 		sideButtons2.addMembers(addButton2, editButton2, deleteButton2, setsButton2);
		...
		sectionForm.addSection("Protocolos Mantenimiento", protMantLayout, false);
