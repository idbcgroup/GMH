...
public class MaintenanceProtocolAddForm extends GHASlideInWindow implements MaintenanceProtocolSelectionListener, MaintenanceProtocolSelectionProducer {
	...
	public void addMaintenanceProtocolSelectionListener(
		...
		maintenanceProtocolForm.addMaintenanceProtocolSelectionListener(maintenanceProtocolSelectionListener);
	}
	...
	public void removeMaintenanceProtocolSelectionListener(
			MaintenanceProtocolSelectionListener maintenanceProtocolSelectionListener) {
		maintenanceProtocolForm.removeMaintenanceProtocolSelectionListener(maintenanceProtocolSelectionListener);
	}
