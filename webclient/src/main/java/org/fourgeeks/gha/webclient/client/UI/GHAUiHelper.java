...
public class GHAUiHelper {
	...
	public static int calculateTabHeight(){
		...
		int topPartHeight = RootPanel.get("top-bar").getOffsetHeight() + RootPanel.get("header-bar").getOffsetHeight() + RootPanel.get("menu-bar").getOffsetHeight();
		int footerHeight = RootPanel.get("footer-bar").getOffsetHeight();
		
		return rootPanelHeight - topPartHeight - footerHeight;
	}
	
	public static int calculateBottomSectionHeight(){
