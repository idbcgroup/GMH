...
public class LoginPlace extends GHAPlace {
	...
	public void show() {
		...
		html.append("<input maxlength='10' class='round' id='username' type='text' placeholder='Nombre de usuario'><br/>");
		html.append("<input maxlength='10' class='round' id='password' type='password' placeholder='Contraseña'> <br/>");
