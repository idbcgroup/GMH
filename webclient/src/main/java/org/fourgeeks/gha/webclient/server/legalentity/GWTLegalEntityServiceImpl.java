...
public class GWTLegalEntityServiceImpl extends RemoteServiceServlet implements
		GWTLegalEntityService {
	@EJB(lookup = "java:global/ear-1/ejb-1/LegalEntityService")
	 ...
	 * 
	 * @see
	 * org.fourgeeks.gha.webclient.client.legalentity.GWTLegalEntityService#
	 * delete(long)
	 */
	@Override
	 ...
	 * @see
	 * org.fourgeeks.gha.webclient.client.legalentity.GWTLegalEntityService#
	 * find(org.fourgeeks.gha.domain.mix.LegalEntity)
	 */
	@Override
	 ...
	 * @see
	 * org.fourgeeks.gha.webclient.client.legalentity.GWTLegalEntityService#
	 * save(org.fourgeeks.gha.domain.mix.LegalEntity)
	 */
	@Override
	 ...
	 * @see
	 * org.fourgeeks.gha.webclient.client.legalentity.GWTLegalEntityService#
	 * update(org.fourgeeks.gha.domain.mix.LegalEntity)
	 */
	@Override
