...
public class EIATypeConsumablesGridPanel extends VLayout implements EIATypeSelectionListener,GHAClosable{

	private EIATypeConsumablesGrid eiaTypeConsumablesGrid = new EIATypeConsumablesGrid();
	
	public EIATypeConsumablesGridPanel() {
		setWidth100();
...
//						History.newItem("eia/" + selectedRecord.getCode());
		...
		mainPanel.addMembers(eiaTypeConsumablesGrid, sideButtons);
