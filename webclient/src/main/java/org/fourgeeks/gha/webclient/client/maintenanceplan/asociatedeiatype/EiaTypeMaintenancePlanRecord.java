 ...
 * 
 */
public class EiaTypeMaintenancePlanRecord extends
		GHAGridRecord<EiaTypeMaintenancePlan> {
	...
	public void setEiaTypeAttributes() {
		...
		if (this.eiaTypeMaintenancePlan.getEiaType().getBrand() != null) {
			setAttribute("brand", this.eiaTypeMaintenancePlan.getEiaType()
					.getBrand().getName());
			if (this.eiaTypeMaintenancePlan.getEiaType().getBrand()
					.getManufacturer() != null)
				setAttribute("manufacturer", this.eiaTypeMaintenancePlan
						.getEiaType().getBrand().getManufacturer().getName());
		}

		setAttribute("model", this.eiaTypeMaintenancePlan.getEiaType()
				.getModel());
	}
