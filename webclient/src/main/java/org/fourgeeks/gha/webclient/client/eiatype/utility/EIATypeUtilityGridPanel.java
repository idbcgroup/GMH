...
public class EIATypeUtilityGridPanel extends GHAFormLayout implements
						...
						EIATypeMaterialBrandModel.save(entity,
								new GHAAsyncCallback<EiaTypeMaterialBrand>() {
									...
									public void onSuccess(
											EiaTypeMaterialBrand arg0) {
										GHAErrorMessageProcessor
												.alert("eiatype-utility-save-success");
										loadData();
									}
								});
					}
	...
	public EIATypeUtilityGridPanel() {
		...
		addMembers(new GHATopTitleLabel(GHAStrings.get("utility-services")), mainPanel);
	}
	...
	private void delete() {
		...
		if (grid.getSelectedRecords().length > 1) {
			GHAErrorMessageProcessor.confirm(
					"eiatype-utilities-delete-confirm", new BooleanCallback() {
			...
			GHAErrorMessageProcessor.confirm("eiatype-utility-delete-confirm",
					new BooleanCallback() {
