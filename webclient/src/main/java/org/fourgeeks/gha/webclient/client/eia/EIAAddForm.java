...
public class EIAAddForm extends GHASlideInWindow {
	...
	public EIAAddForm() {
		...
		// GHACheckboxItem isMant = new
		// GHACheckboxItem("Equipo en Mantenimiento");
		// GHATextItem codeMant = new
		// GHATextItem("Cod. Ubicación Mantenimiento");
		// codeMant.setWidth(170);
		// GHATextItem nameMant = new
		// GHATextItem("Nombre Ubicación Mantenimiento");
		// nameMant.setWidth(180);
		// GHATextItem providerMant = new
		// GHATextItem("Proveedor de Mantenimiento");
		...
		//
		// mantenimientoForm.setItems(mantenimientoTitle, garantiaDesde,
		// garantía,
		...
		// GHATextItem fechaContab = new
		// GHATextItem("Fecha de Contabilización");
		...
		//
		// costoAdqForm.setItems(adqCostTitle, costoAdq, currencyAdq,
		// fechaContab,
		// costoAdqLoc, monedaLocal);
		//
		// // //////Costo Actual form
		// GHATitleTextItem actualCostTitle = new
		// GHATitleTextItem("Costo Actual:");
		...
		// GHADateItem fechaDesinc = new
		// GHADateItem("Fecha de Desincorporación");
		// fechaDesinc.setWidth(150);
		// GHATextItem motivoDesinc = new
		// GHATextItem("Motivo de Desincorporacion");
		...
		// "<h3>Detalle de características de Equipos</h3>");
		// title.setWidth(400);
		...
		// mantenimientoForm, garantiaInmForm, costoAdqForm, costoActForm,
		// equiposITForm);
		//
		//
