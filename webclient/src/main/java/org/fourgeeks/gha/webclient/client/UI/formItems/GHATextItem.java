...
public class GHATextItem extends TextItem {
	 ...
	 * @author Guerere
	 * 
	 * @Metodo: Valida que solo se ingresen letras usando la expresion regular
	 *          ^[a-zA-ZáéíóúAÉÍÓÚÑñ]+$ recibe por parametro el mensaje de error
	 *          que sera mostrado por el campo
	 */
	...
	public void validateWords() {
		validateCustomExpre(GHAStrings.get("formatter-error-words"),
				"^[a-zA-ZáéíóúÁÉÍÓÚÑñ ]+$");
	}

	public void validateDates() {
		validateCustomExpre(GHAStrings.get("formatter-error-dates"),
				"^[0-9]{2}/[0-9]{2}/[0-9]{4}$");
	}

	public void validateNumbers() {
		validateCustomExpre(GHAStrings.get("formatter-error-numbers"),
				"^[0-9]+$");
	}
	...
	public void validateCodes() { // alfanumerico sin espacio
		validateCustomExpre(GHAStrings.get("formatter-error-codes"),
				"^[a-zA-Z0-9]+$");
	}

	public void validateRif() {
		validateCustomExpre(GHAStrings.get("user-error-formatter-rif"),
				"^[VvMmPprREeJjIiGg0-9|-]+$");
	}
}