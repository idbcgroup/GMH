...
public class CitizenContact extends AbstractEntity {
	...
	/** CONTACT_TYPE length =60 */

	private ContactRelationTypeEnum contactRelationType;
	/** CONTACT_RELATION_TYPE length =60 */

	private String contactFirstName;
	/** CONTACT_FIRST_NAME length =255 */
	private String contactLastName;
	/** CONTACT_LAST_NAME length =255 */
	...
	/** CONTACT_EMAIL length =255 */
	private String contactJobPosition;

	/** CONTACT_JOB_POSITION length =255 */
