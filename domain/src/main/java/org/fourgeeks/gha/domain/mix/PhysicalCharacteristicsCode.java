...
public class PhysicalCharacteristicsCode extends AbstractEntity {
	...
	/**
	 * Fecha de Creación de las Señas o Características Fïsicas asociadas a un
	 * CIUDADANO length =12
	 */

	private PccStatusEnum pccStatus;
	/**
	 * Validez de las Señas o Características Fïsicas asociadas a un CIUDADANO
	 * length =60
	 */
