...
public class CitizenPicture extends AbstractEntity {
	...
	/** Attributes */
	private Long citizenIdFk;
	/** <FKEY> ID del Ciudadano con Foto length =19 */
	...
	/** Descripción de la FOTO del Ciudadano - OPCIONAL length =255 */
	private Date pictureDate;
	/** Fecha en que se tomo la foto length =22 */

	private PictureStateEnum pictureState;
